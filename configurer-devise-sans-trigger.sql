-- ====================================
-- CONFIGURATION AUTOMATIQUE DE LA DEVISE (SANS PROBLÈME DE TRIGGER)
-- Version qui désactive temporairement les triggers
-- ====================================
...
-- IMPORTANT : Désactiver les triggers pour éviter les erreurs
...
-- Mettre à jour manuellement updatedAt si la colonne existe (pour éviter les problèmes)
DO $$
BEGIN
