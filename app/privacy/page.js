      ...
      try {
        ...
        if (error) {
          if (error.code === 'PGRST116') {
            console.log('Page "privacy" non trouvée dans la base de données')
            setPage(null)
          } else {
          ...
          console.log('Page Confidentialité chargée:', {
            title: data.title,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          {page ? (
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold text-solidarpay-text mb-4">Politique de Confidentialité</h1>
